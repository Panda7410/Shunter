namespace GSSC.Condition
{
    ...
    using GSSC.Signal;
    using System;
    [AddComponentMenu("GSSC/콜백이벤트")]
    public class ConditionEventCallback : ConditionEventCallbackBase
    {
        [TextArea]
        ...
        [Header("조건리스트")]
        [SerializeField]
        private ConditionBaseSelector BaseSelector;
        [Header("완료시 실행 이벤트")]
